const FEATURES = [
  ...
  { icon: '🌙', title: 'Dark Mode by Default', desc: "High contrast UI everywhere. An accessibility tool that's actually accessible." },
    ...
    <section className="px-6 py-16 max-w-4xl mx-auto">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {FEATURES.map(({ icon, title, desc }) => (
          <div key={title} className="flex flex-col gap-2 p-5 bg-dark-surface border border-dark-border rounded-2xl hover:border-gray-600 transition-colors">
